...
public static class ProsperoImageDigests
{
    ...
    /// <summary>
    /// SHA3-256, the single PS5 PFS/finalized-image digest primitive. Uses OS SHA-3 when available,
    /// otherwise a managed Keccak implementation so macOS can build packages.
    /// </summary>
